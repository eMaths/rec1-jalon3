# Log de récupération des articles

Date de traitement: 2025-12-13 13:55:23

Nombre d'articles traités: 45

**Problématique**: Comment concevoir et évaluer des modèles d'apprentissage automatique plus durables en réduisant leur consommation d'énergie tout en conservant des performances satisfaisantes ?

---

## Article: Machine Learning Approaches for Effective Energy-Efficient Resource Management Strategies in Cloud Services
- **Auteurs**: Abhilasha Chauhan, Suchi Johari
- **Lien**: [DOI](https://doi.org/https://doi.org/10.1201/9781003457152-4)
- **Abstract**: Non disponible
- **Article retenu ?** False
- **Raisons**:
    - ❌ Titre: L'article traite de la gestion des ressources, pas de l'efficacité des modèles ML

---

## Article: A wavelet-based sampling algorithm for wireless sensor networks applications
- **Auteurs**: André L. L. Aquino, Ricardo Oliveira, Elizabeth F. Wanner
- **Lien**: [DOI](https://doi.org/https://doi.org/10.1145/1774088.1774433)
- **Abstract**: This work proposes and evaluates a sampling algorithm based on wavelet transforms with Coiflets basis to reduce the data sensed in wireless sensor networks applications. The Coiflets basis is more computationally efficient when data are smooth, which means that, data are well approximated by a polynomial function. As expected, this algorithm reduces the data traffic in wireless sensor network and, consequently, decreases the energy consumption and the delay to delivery the sensed information. The main contribution of this algorithm is the capability to detect some event by adjusting the sampling dynamically. In order to evaluate the algorithm, we compare it with a static sampling strategy considering a real sensing data where an external event is simulated. The results reveal the efficiency of the proposed method by reducing the data without loosing its representativeness, including when some event occurs. This algorithm can be very useful to design energy-efficient and time-constrained sensor networks when it is necessary to detect some event.
- **Article retenu ?** False
- **Raisons**:
    - ❌ Titre: L'article traite des capteurs sans fil, pas de l'efficacité des modèles ML

---

## Article: Data-driven Urban Energy Simulation (DUE-S): A framework for integrating engineering simulation and machine learning methods in a multi-scale urban energy modeling workflow
- **Auteurs**: Alex Nutkiewicz, Yang Zheng, Rishee K. Jain
- **Lien**: [DOI](https://doi.org/https://doi.org/10.1016/j.apenergy.2018.05.023)
- **Abstract**: Non disponible
- **Article retenu ?** False
- **Raisons**:
    - ❌ Titre: L'article traite de l'énergie urbaine, pas des modèles ML

---

## Article: Data-driven Energy-efficient Adaptive Sampling Using Deep Reinforcement Learning
- **Auteurs**: Berken Utku Demirel, Luke Chen, Mohammad Abdullah Al Faruque
- **Lien**: [DOI](https://doi.org/https://doi.org/10.1145/3598301)
...
## Article: A Reinforcement Learning Based Framework for Holistic Energy Optimization of Sustainable Cloud Data Centers
- **Auteurs**: Daming Zhao, Jian-Tao Zhou, Jidong Zhai, Keqin Li
- **Lien**: [DOI](https://doi.org/https://doi.org/10.1109/TSC.2024.3495495)
...
- **Article retenu ?** False
- **Raisons**:
    - ❌ Titre: L'article traite de la détection de spectre, pas des modèles ML

---

## Article: Prediction of Rut Depth in Soil Caused by Wheels Using Artificial Neural Networks
- **Auteurs**: Nashmil F.
- **Lien**: [DOI](https://doi.org/https://doi.org/10.22067/jam.2024.90273.1295)
- **Abstract**: Non disponible
- **Article retenu ?** False
- **Raisons**:
    - ❌ Titre: L'article traite du sol/agriculture, pas des modèles ML

---

## Article: Evaluating the sensitivity of the landslide event using the support vector machine algorithm
- **Auteurs**: Rostamizad G.
- **Lien**: [DOI](https://doi.org/https://doi.org/10.22098/mmws.2023.13934.1379)
- **Abstract**: Non disponible
- **Article retenu ?** False
- **Raisons**:
    - ❌ Titre: L'article traite des glissements de terrain, pas des modèles ML

---

## Article: Coupling simulation-based and machine learning methodologies for energy optimization and environmental impact mitigation in buildings
- **Auteurs**: G. Mihalakakou, Athanasios Giannadakis, Sonia Malefaki, Manolis Souliotis, Pantazis Georgiou, Alexandros Romeos, Anastasia Antzoulatou, Pantelis G. Nikolakopoulos, John A. Paravantis
- **Lien**: [DOI](https://doi.org/https://doi.org/10.1016/j.jobe.2025.113809)
- **Abstract**: Non disponible
- **Article retenu ?** True
- **Raisons**:
    - ⚠️ Titre: Pas d'indicateur clair de Green AI, analyse de l'abstract nécessaire
...
## Article: 单/双目深度估计研究进展与应用综述(特邀)
- **Auteurs**: 胡海洋 HU Haiyang, 陈超平 CHEN Chaoping, 高天沐 GAO Tianmu, 韩宝恩 HAN Baoen, 杨云帆 YANG Yunfan, 刘毅 LIU Yi, 武小军 WU Xiaojun
- **Lien**: [DOI](https://doi.org/https://doi.org/10.3788/IRLA20250157)
- **Abstract**: Non disponible
- **Article retenu ?** True
- **Raisons**:
    - ⚠️ Titre: Pas d'indicateur clair de Green AI, analyse de l'abstract nécessaire
...
## Article: Electricity peak shaving for commercial buildings using machine learning and vehicle to building (V2B) system
- **Auteurs**: Mahdi Ghafoori, Moatassem Abdallah, Seo Young Kim
- **Lien**: [DOI](https://doi.org/https://doi.org/10.1016/j.apenergy.2023.121052)
- **Abstract**: Non disponible
- **Article retenu ?** True
- **Raisons**:
    - ⚠️ Titre: Pas d'indicateur clair de Green AI, analyse de l'abstract nécessaire
...
## Article: Full analysis and deep learning optimization of a sustainable and eco-friendly power plant to generate green hydrogen and electricity; A zero-carbon approach
- **Auteurs**: Poorya Asadbagi, Adib Mahmoodi Nasrabadi, Carrie M. Hall
- **Lien**: [DOI](https://doi.org/https://doi.org/10.1016/j.psep.2024.07.029)
- **Abstract**: Non disponible
- **Article retenu ?** True
- **Raisons**:
    - ⚠️ Titre: Pas d'indicateur clair de Green AI, analyse de l'abstract nécessaire
...
## Article: Exploring influential parameters affecting residential building energy use: advancing energy efficiency through machine learning
- **Auteurs**: P. Chaturvedi, Nand Kumar, Jørn Toftum, Rune Korsholm Andersen, Ravita Lamba, Kedar Mehta
- **Lien**: [DOI](https://doi.org/https://doi.org/10.1007/s10098-025-03301-x)
- **Abstract**: Non disponible
- **Article retenu ?** False
- **Raisons**:
    - ❌ Titre: L'article traite de l'efficacité énergétique des bâtiments, pas des modèles ML

---

## Article: Uncertainty-Aware Deep Reinforcement Learning for Trainable Equivalent Consumption Minimization Strategy of Fuel Cell Hybrid Electric Tracked Vehicle
- **Auteurs**: Qicong Su, Ruchen Huang, Zhendong Zhang, Yiwen Shou, Hongwen He
- **Lien**: [DOI](https://doi.org/https://doi.org/10.1109/TTE.2025.3563203)
- **Abstract**: Non disponible
- **Article retenu ?** False
- **Raisons**:
    - ❌ Titre: L'article traite des piles à combustible, pas des modèles ML

---

## Article: An adaptive federated learning system for community building energy load forecasting and anomaly prediction
- **Auteurs**: Rui Wang, Hongguang Yun, Rakiba Rayhana, Junchi Bin, Chengkai Zhang, Omar E. Herrera, Zheng Liu, Walter Mérida
- **Lien**: [DOI](https://doi.org/https://doi.org/10.1016/j.enbuild.2023.113215)
- **Abstract**: Non disponible
- **Article retenu ?** False
- **Raisons**:
    - ❌ Titre: L'article traite de l'efficacité énergétique des bâtiments, pas des modèles ML
...
## Article: IoT-based smart healthcare using efficient data gathering and data analysis
- **Auteurs**: Raja Basha Adam Sahib, R. Bhavani
- **Lien**: [DOI](https://doi.org/https://doi.org/10.1007/s12083-024-01823-7)
- **Abstract**: Non disponible
- **Article retenu ?** False
- **Raisons**:
    - ❌ Titre: L'article traite de la santé, pas de l'efficacité des modèles ML

---

## Article: Data Driven Energy Economy Prediction for Electric City Buses Using Machine Learning
- **Auteurs**: Roman Michael Sennefelder, Rubén Martı́n-Clemente, R.G. Carvajal, Dimitar Trifonov
- **Lien**: [DOI](https://doi.org/https://doi.org/10.1109/ACCESS.2023.3311895)
...
## Article: Augmented Deep Reinforcement Learning for Online Energy Minimization of Wireless Powered Mobile Edge Computing
- **Auteurs**: Xiaojing Chen, Weiheng Dai, Wei Ni, Xin Wang, Shunqing Zhang, Shugong Xu, Yanzan Sun
- **Lien**: [DOI](https://doi.org/https://doi.org/10.1109/TCOMM.2023.3251353)
...
- **Article retenu ?** False
- **Raisons**:
    - ❌ Titre: L'article traite de l'alimentation sans fil, pas de l'efficacité des modèles ML

---

## Article: Designing energy-efficient buildings in urban centers through machine learning and enhanced clean water managements
- **Auteurs**: Ximo Chen, Zhaojuan Zhang, Azher M. Abed, Luning Lin, Haqi Zhang, José Escorcia‐Gutierrez, Ahmed Ali A. Shohan, Elimam Ali, Huiting Xu, Hamid Assilzadeh, Lei Zhen
- **Lien**: [DOI](https://doi.org/https://doi.org/10.1016/j.envres.2024.119526)
- **Abstract**: Non disponible
- **Article retenu ?** False
- **Raisons**:
    - ❌ Titre: L'article traite de la gestion de l'eau, pas des modèles ML

---

## Article: Deep Learning-Based Building Energy Optimization Using BIM Data &amp; Evaluating Energy Savings Potential
- **Auteurs**: Yogesh Rajput, Sonali Gaikwad, Jyotsna Gaikwad
- **Lien**: [DOI](https://doi.org/https://doi.org/10.1007/978-981-96-4136-9_23)
- **Abstract**: Non disponible
- **Article retenu ?** False
- **Raisons**:
    - ❌ Titre: L'article traite de l'efficacité énergétique des bâtiments, pas des modèles ML
...
- **Article retenu ?** False
- **Raisons**:
    - ❌ Titre: L'article traite de la fabrication de semi-conducteurs, pas des modèles ML
